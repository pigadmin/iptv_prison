...
//                Logs.d("准备创建/storage/emulated/0/TbsReaderTemp！！");
//                boolean mkdir = bsReaderTempFile.mkdir();
//                if(!mkdir){
//                    Logs.e("创建/storage/emulated/0/TbsReaderTemp失败！！！！！");
//                }
//            }
//
//            //加载文件
//            Bundle localBundle = new Bundle();
//            Logs.d(mFile.toString());
...
//            Logs.d( "paramString---->null");
//            return str;
//        }
//        Logs.d( "paramString:" + paramString);
...
//        Logs.d( "paramString.substring(i + 1)------>" + str);
//        return str;
//    }
//
//    public void show() {
