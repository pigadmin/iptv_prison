 ...
 */
public class WZDateUtil extends DateUtils {
...
//		return parseDate(str, new String[] { parsePatterns });
    ...
    public static Date timeToDate(String data, Date time) {
        try {
            return parseDate(data + " " + time.getHours() + ":" + time.getMinutes() + ":" + time.getSeconds(), "yyyy-MM-dd HH:mm:ss");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return new Date();
