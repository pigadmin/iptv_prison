...
public class NewsGridAdapter extends BaseAdapter {
    ...
    public NewsGridAdapter(Activity activity, List<News> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.vod_name.setText(list.get(position).getTitle());
        ImageUtils.display(holder.vod_bg, list.get(position).getThumbnail_pic_s());
        return convertView;
